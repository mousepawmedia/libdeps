\hypertarget{opus_8h}{}\section{opus.\+h File Reference}
...
\begin{center}
\leavevmode
\includegraphics[width=194pt]{opus_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=182pt]{opus_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Typedefs}
...
\begin{DoxyCompactList}\small\item\em Perform a C\+TL function on an Opus encoder. \end{DoxyCompactList}\item 
